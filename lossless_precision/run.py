...
csv_header = ['EyeBlinkLeft', 'EyeLookDownLeft', 'EyeLookInLeft', 'EyeLookOutLeft', 'EyeLookUpLeft',
                      ...
                      'CheekSquintRight', 'NoseSneerLeft', 'NoseSneerRight', 'TongueOut', 'HeadYaw', 'HeadPitch',
                      'HeadRoll', ]
...
if __name__ == '__main__':
    ...
    for exf in extract_frame:
        ...
        # decode
        decode_to_csv(csv_header, enc_input_folder, enc_output_folder,dec_output_folder, start_time)
