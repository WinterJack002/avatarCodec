...
def frame_extraction(directory_path, subdir_path, num):
    """
...
extract_frame = [10,30]
input_floder = r'C:\Users\winter\Desktop\DCC_avatar\实验资源数据\csv编解码文件和bin文件\线性插值分析\原始30帧'
output_folder = r'C:\Users\winter\Desktop\DCC_avatar\实验资源数据\csv编解码文件和bin文件\线性插值分析\3FPS+1FPS'
for exf in extract_frame:
    frame_extraction(input_floder, output_folder, exf)